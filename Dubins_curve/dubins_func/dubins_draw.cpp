...
void Dubins::draw_vector_on_map( std::array<float, 3> vect )
{
...
// void Dubins::draw_arc(std::array<float, 3> node_pose, std::array<float, 3> next_pose, int radius, float arc_angle, int motion_type, int thickness, cv::Scalar color)
// {
