...
int astar::check_collision(float x, float y, int scan_range)
{
...
void astar::map_inflation(cv::Mat *mapIn, cv::Mat *mapOut, int infla_size)
{
...
int astar::improve_hcost(std::array<float, 3> node_pose, int hcost, int scan_range, bool same_steer)
{
